...
-- at runtime using the environment variable charon_hs_bindir.
...
-- environment variable charon_hs_libdir.
...
-- using the environment variable charon_hs_dynlibdir.
...
-- runtime using the environment variable charon_hs_datadir.
...
-- using the environment variable charon_hs_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/charon-hs-0.1.0.0-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/charon-hs-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/charon-hs-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "charon_hs_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "charon_hs_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "charon_hs_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "charon_hs_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "charon_hs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "charon_hs_sysconfdir") (\_ -> return sysconfdir)
