...
#[visitable_group(
    ...
    drive(
        ...
        llbc_ast::ExprBody, llbc_ast::SpecBlock, llbc_ast::Specs, llbc_ast::StatementKind, llbc_ast::Switch,
        ...
        ullbc_ast::BlockData, ullbc_ast::BlockId, ullbc_ast::ExprBody, ullbc_ast::SpecBlock, ullbc_ast::Specs, ullbc_ast::StatementKind,
...
#[visitable_group(
    ...
    drive(
        Assert, PlaceKind,
        llbc_ast::ExprBody, llbc_ast::SpecBlock, llbc_ast::Specs, llbc_ast::StatementKind, llbc_ast::Switch,
        ullbc_ast::BlockData, ullbc_ast::ExprBody, ullbc_ast::SpecBlock, ullbc_ast::Specs, ullbc_ast::StatementKind,
