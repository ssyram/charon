...
#[visitable_group(
    ...
    drive(
        ...
        llbc_ast::ExprBody, llbc_ast::FunSpecBlock, llbc_ast::FunSpecs, llbc_ast::StatementKind, llbc_ast::Switch,
        Locals, Name, NullOp, Operand, PathElem, PlaceKind, ProjectionElem, ConstantExprKind,
        RefKind, RegionId, RegionParam, ScalarValue, SpecCall, TraitItemName,
        TranslatedCrate, TypeDeclKind, TypeId, TypeParam, TypeVarId, llbc_ast::StatementId,
        ullbc_ast::BlockData, ullbc_ast::BlockId, ullbc_ast::ExprBody, ullbc_ast::FunSpecBlock, ullbc_ast::FunSpecs, ullbc_ast::StatementKind,
        ...
        TraitAssocTy, TraitAssocConst, TraitMethod, TraitAssocTyImpl, TypeSpecs,
...
#[visitable_group(
    ...
    drive(
        Assert, PlaceKind,
        llbc_ast::ExprBody, llbc_ast::FunSpecBlock, llbc_ast::FunSpecs, llbc_ast::StatementKind, llbc_ast::Switch,
        ullbc_ast::BlockData, ullbc_ast::ExprBody, ullbc_ast::FunSpecBlock, ullbc_ast::FunSpecs, ullbc_ast::StatementKind,
