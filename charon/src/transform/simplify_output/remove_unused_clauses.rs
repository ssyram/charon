...
impl VisitAst for BuildGraphVisitor<'_> {
    ...
    fn visit_spec_closure_id(&mut self, x: &SpecClosureId) -> ControlFlow<Self::Break> {
        self.visit(&self.spec_closures[*x])
    }
}
...
impl TransformPass for Transform {
    ...
    fn transform_ctx(&self, ctx: &mut TransformCtx) {
        ...
        let graph: DiGraphMap<ClauseNode, ()> = {
            ...
            for item in ctx.translated.all_items() {
                ...
                let mut visitor = BuildGraphVisitor {
                    ...
                    spec_closures: &ctx.translated.spec_closures,
                };
        ...
        let mut spec_closures = std::mem::take(&mut ctx.translated.spec_closures);
