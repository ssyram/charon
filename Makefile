...
.PHONY: test
test: clean-generated build-dev charon-tests charon-ml-tests test-hs
...
# Run the Charon Haskell tests on the .llbc files generated by Charon
.PHONY: test-hs
test-hs: charon-tests
	cd charon-hs && stack test
