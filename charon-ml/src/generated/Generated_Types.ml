 ...
 *) and  trait_instance_id = 
 ...
 | BuiltinOrAuto of ( trait_ref) list *(( trait_item_name)*( trait_assoc_ty_impl)) list  (** A trait implementation that is computed by the compiler, such as for built-in trait
