...
(* Lookup the signature of a method. This returns a signature bound in two
   ...
   found.
*)
let lookup_method_sig (crate : ('a, 'b) gcrate) (trait_id : trait_decl_id)
...
let lookup_flat_method_sig (crate : ('a, 'b) gcrate) (trait_id : trait_decl_id)
...
let lookup_fndef_sig (crate : ('a, 'b) gcrate) (fn_ptr : fn_ptr region_binder) :
